...
Lagdo.DbAdmin.Ajax.Log.Commands.page = function() {
    return jaxon.request({ type: 'class', name: 'Lagdo.DbAdmin.Ajax.Log.Commands', method: 'page' }, { parameters: arguments, bags: ["dbadmin.logging"] });
};
Lagdo.DbAdmin.Ajax.Log.Commands.show = function() {
    return jaxon.request({ type: 'class', name: 'Lagdo.DbAdmin.Ajax.Log.Commands', method: 'show' }, { parameters: arguments, bags: ["dbadmin.logging"] });
};
Lagdo.DbAdmin.Ajax.Log.Commands.render = function() {
    return jaxon.request({ type: 'class', name: 'Lagdo.DbAdmin.Ajax.Log.Commands', method: 'render' }, { parameters: arguments, bags: ["dbadmin.logging"] });
};
Lagdo.DbAdmin.Ajax.Log.Commands.clear = function() {
    return jaxon.request({ type: 'class', name: 'Lagdo.DbAdmin.Ajax.Log.Commands', method: 'clear' }, { parameters: arguments, bags: ["dbadmin.logging"] });
};
Lagdo.DbAdmin.Ajax.Log.Commands.visible = function() {
    return jaxon.request({ type: 'class', name: 'Lagdo.DbAdmin.Ajax.Log.Commands', method: 'visible' }, { parameters: arguments, bags: ["dbadmin.logging"] });
};
